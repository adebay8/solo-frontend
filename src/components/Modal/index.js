...
import { Spinner, Icon as AppIcon, Button } from "../index";
    ...
    {closable && (
      <div className={"close-button"} onClick={onClick}>
        <div className="close-button-wrapper">
          <AppIcon size={25} name="close" type="fa" />
        </div>
      </div>
    )}
...
const Modal = (props) => {
  ...
  return (
    <div
      className={`modal-root-fixed ${props.className} ${
        props.infiniteWidth && "infinite-width"
      }`}
    >
